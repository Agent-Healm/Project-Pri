...
public class LayoutDrawer : PropertyDrawer
{
    ...
    public static void AddPropertyDataWithPath(string propPath, string propPathParent)
    {
        foreach (var verticalField in _verticalFields)
        {
            // if (verticalField.propertyData[0]?.propertyPath == propPathParent)
    ...
    // private static SerializedObject _soObject;
